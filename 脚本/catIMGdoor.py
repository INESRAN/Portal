...
data_dir1 = '/home/yangzhihui/f2nerf1/exp/sanchangjingmen'
...
for n in range(len(imgs1)):
    imgs_in1 = imgs1[n]
    masks = 255 - np.logical_and(imgs_in1[:, :, 0] < 240, imgs_in1[:, :, 1] < 200, imgs_in1[:, :, 2] > 100)*255
    ...
    new_img.save(f"/home/yangzhihui/f2nerf1/exp/sanchangjingnomen/{n:05}.png")
